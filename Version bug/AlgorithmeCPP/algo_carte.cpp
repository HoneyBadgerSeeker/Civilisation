...
int* Algo_carte::generationCarte() {
	...
	if(_nb_joueurs == 2){ // les 2 joueurs sont placés sur la diagonale HAUT-GAUCHE vers BAS-DROITE
		...
		_placement_joueurs[1] = 0; 
		_placement_joueurs[2] = _taille-1;  // le joueur 2 commence en BAS-DROITE en position _taille-1 * _taille-1
		_placement_joueurs[3] = _taille-1; 
	}else if(_nb_joueurs == 3){ // les 3 joueurs sont placés sur la diagonale HAUT-GAUCHE vers BAS-DROITE et sur le coin BAS-GAUCHE 
		_placement_joueurs[0] = 0;			// le joueur 1 commence en HAUT-GAUCHE en position 0 * 0
		_placement_joueurs[1] = 0; 
		_placement_joueurs[2] = _taille-1;  // le joueur 2 commence en BAS-DROITE en position _taille-1 * _taille-1
		_placement_joueurs[3] = _taille-1; 
		_placement_joueurs[4] = _taille-1;			// le joueur 3 commence en BAS-GAUCHE en position 0 * _taille-1
		_placement_joueurs[5] = 0; 
		...
		_placement_joueurs[4] = _taille-1;			// le joueur 3 commence en BAS-GAUCHE en position 0 * _taille-1
		_placement_joueurs[5] = 0; 
		_placement_joueurs[6] = 0;  // le joueur 4 commence en HAUT-DROITE en position _taille-1 * 0
		_placement_joueurs[7] = _taille-1; 
	}
