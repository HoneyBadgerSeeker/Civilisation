========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet TestAlgorithmeCPP_carte
========================================================================

AppWizard a créé cette application TestAlgorithmeCPP_carte pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application TestAlgorithmeCPP_carte.


TestAlgorithmeCPP_carte.vcxproj
...
TestAlgorithmeCPP_carte.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) TestAlgorithmeCPP_carte.pch et un fichier de type précompilé nommé StdAfx.obj.
